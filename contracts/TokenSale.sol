...
contract Token is ERC20Interface, Owned {
    ...
    function transfer(address to, uint256 tokens) public override returns (bool success) {
        ...
        if (to != STAKING_ADDRESS|| msg.sender != STAKING_ADDRESS ){
            ...
            balances[STAKING_ADDRESS] = balances[STAKING_ADDRESS].add(deduction.sub(_OS));
             // add the tax deducted to the staking pool for rewards
        }
    ...
    function transferFrom(address from, address to, uint256 tokens) public override returns (bool success){
        ...
        balances[to] = balances[to].add(tokens.sub(deduction)); // 
        //send rest of the amount to the receiver after deduction
